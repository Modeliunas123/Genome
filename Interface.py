...
# -------------------------------------------MAIN  INTERFACE-------------------------------------------------------------
def main_window():
    main_layout = [[Interface.Text('This is the Genome Program for evaluating DNA or RNA strands',
                                   justification='center', size=(150, 1))],
                   [Interface.Text('into their amino acid counterparts, determining the hypothetical',
                                   justification='center', size=(150, 1))],
                   [Interface.Text('molecular weight, pKA value, and their genomic content.', justification='center',
                                   size=(150, 1))],
                   [Interface.VPush(), Interface.Text('Please choose whether you have a DNA or RNA sequence below:',
                                                      justification='center', size=(150, 1))],
                   [Interface.VPush(), Interface.Button('DNA', size=(5, 1)), Interface.Button("RNA", size=(5, 1)),
                    Interface.Button('Strand Conversion', size=(15, 1)), Interface.Push(),
                    Interface.Button('Exit', size=(5, 1))]]
...
def DNA_window():
    layout_DNA = [[Interface.Text('You have chosen a DNA sequence', justification='center', size=(150, 1))],
                  [Interface.Text('Please choose whether you would like to convert this:', justification='center',
                                  size=(150, 1))],
                  [Interface.Text('to an amino acid or calculate the AT/CG content below:', justification='center',
                                  size=(150, 1))],
                  [Interface.VPush(), Interface.Button('Amino acid converter', size=(15, 1)),
                   Interface.Button('AT/CG calculator', size=(15, 1)), Interface.Button('Back'), Interface.Push(),
                   Interface.Button('Exit', size=(5, 1))]]
...
def DNA_amino_acid_window():
    layout_DNA = [[Interface.Text('DNA to amino acid conversion', justification='center', size=(150, 1))],
                  ...
                  [Interface.VPush(), Interface.Button('Okay', size=(15, 1)),
                   Interface.Button('Main Menu', size=(15, 1)), Interface.Push(),
                   Interface.Button('Exit', size=(5, 1))]]
...
def RNA_window():
    layout_DNA = [[Interface.Text('You have chosen an RNA sequence', justification='center', size=(150, 1))],
                  [Interface.Text('Please choose whether you would like to convert this:', justification='center',
                                  size=(150, 1))],
                  [Interface.Text('to an amino acid or calculate the AU/CG content below:', justification='center',
                                  size=(150, 1))],
                  [Interface.VPush(), Interface.Button('Amino acid converter', size=(15, 1)),
                   Interface.Button('AU/CG calculator', size=(15, 1)), Interface.Button('Back'), Interface.Push(),
                   Interface.Button('Exit', size=(5, 1))]]
...
def DNA_and_RNA_window():
    layout_DNA_and_RNA = [
        [Interface.Text('You have selected strand conversion', justification='center', size=(150, 1))],
        [Interface.Text('Would you like to convert DNA -> RNA or RNA -> DNA?', justification='center', size=(150, 1))],
        [Interface.VPush(), Interface.Button('DNA -> RNA', size=(10, 1)), Interface.Button('RNA -> DNA', size=(10, 1)),
         Interface.Push(), Interface.Button('Back', size=(5, 1)), Interface.Button('Exit', size=(5, 1))]]
